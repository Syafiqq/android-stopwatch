...
data class StopwatchStart(val stopwatch: Stopwatch, val startedAt: LocalDateTime): StopwatchCmd
data class StopwatchPause(val stopwatch: Stopwatch, val pausedAt: LocalDateTime): StopwatchCmd
